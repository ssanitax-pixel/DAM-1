Este ejercicio tiene como objetivo integrar una aplicación web usando **Flask** y **MySQL** para mostrar dinámicamente un portafolio de arte. Utilizando **Python** y **Flask**, se realiza una conexión con la base de datos y se obtiene la información de una vista predefinida. Esta información se presenta de manera dinámica en una página web, donde se generan artículos para cada pieza de arte, mostrando su título, descripción, imagen y categoría. Además, se emplea **HTML** y **CSS** para diseñar la interfaz, con una cabecera y pie de página estáticos, y contenido principal dinámico.
  ...
  <body>
    ...
    for fila in resultados: # Para cada elemento de la lista
        ...
        <article class="piece">
          ...
          <img src="static/'''+fila[2]+'''" class="piece-image">
          <p class="piece-category"><strong>Categoría: </strong>'''+fila[4]+'''</p>
          <a href='''+fila[3]+''' target="_blank">Ver en la galería</a>
        </article>
        '''
    ####### AQUI PONGO EL FINAL
    cadena += '''
