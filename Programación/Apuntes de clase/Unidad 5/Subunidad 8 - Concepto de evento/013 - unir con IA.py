...
ttk.Label(frame_form, text="Dirección:").grid(row=1, column=2, padx=5, pady=5, sticky=W)
direccion = ttk.Entry(frame_form, width=20)
direccion.grid(row=1, column=3, padx=5, pady=5)
...
# --- Treeview setup ---
columnas = ("dninie", "nombre", "apellidos", "email", "direccion")
